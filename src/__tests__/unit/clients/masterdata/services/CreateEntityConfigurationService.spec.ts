...
describe("CreateEntityConfigurationService", () => {
  ...
  it("should throw error when trying to get inexistent instance", async () => {
    ...
    expect(() => { CreateEntityConfigurationService.getInstance() }).toThrowError('No instance of CreateEntityConfigurationService was instantiated')
  })
  ...
  it("should be able to set instance", () => {
    ...
    const { getEntityDetails, getSchema } = CreateEntityConfigurationService.getInstance()
  ...
  it("should be able to call buildSchemaService and execute schema", async () => {
    ...
    const schema = await createEntityConfigurationService.getSchema(jest.fn(), {} as any)
  ...
  it("should be able to return entityName and app", async () => {
    ...
    const createEntityConfigurationService = CreateEntityConfigurationService.getInstance()
    const { app, entityName } = createEntityConfigurationService.getEntityDetails()
