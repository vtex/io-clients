...
describe("masterDataFactory", () => {
  ...
  it("should be able to instantiate a major 1 masterdata builder and setInstance", async () => {
    jest.spyOn(service.CreateEntityConfigurationService, 'setInstance').mockImplementation(jest.fn())
    ...
    const MasterdataInstance = masterDataFor("nameOfEntity", "vtex.app-name@1.1.1", 1)
